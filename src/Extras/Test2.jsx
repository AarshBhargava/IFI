      ...
      <main className="pt-20">
        ...
        <section id="home" className="relative overflow-hidden">
          <div className="absolute inset-0 -z-10">
            <img src="https://images.unsplash.com/photo-1529391387768-ab39476d6a52?q=80&w=626&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="hero background" className="w-full h-full object-cover" />
              ...
              <div className="lg:col-span-7">
                <FadeUp>
                  <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif leading-tight text-gray-900">
                    Arte — Contemporary Art Gallery
                  </h1>
                </FadeUp>
                <FadeUp delay={0.12}>
                  <p className="mt-6 max-w-2xl text-lg text-gray-700">
                    Discover contemporary works from established and emerging artists. Curated exhibitions, exclusive events, and a refined selection of paintings, sculptures and installations.
                  </p>
                </FadeUp>
                <FadeUp delay={0.22}>
        ...
        <section id="exhibition" className="py-20">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="flex items-baseline justify-between">
              <FadeUp><h2 className="text-2xl font-semibold">Current Exhibition</h2></FadeUp>
              <FadeUp delay={0.08}><a href="#" className="text-sm text-gray-700 hover:underline">View all exhibitions</a></FadeUp>
            </div>
                ...
                <FadeUp key={i} delay={0.08 * i}>
                  <article className="group bg-white rounded-lg overflow-hidden shadow-sm">
                    <div className="relative">
                      <img src={url} alt={`Exhibition ${i + 1}`} className="w-full h-64 object-cover group-hover:scale-105 transition-transform duration-400" />
                      <div className="absolute bottom-4 left-4 bg-white/80 px-3 py-2 rounded backdrop-blur text-sm">Open now</div>
                    </div>
                    <div className="p-4">
                      <h3 className="text-lg font-medium">Exhibition Title {i + 1}</h3>
                      <p className="mt-2 text-sm text-gray-600">A short description of the exhibition, the concept, and featured artists.</p>
                      <div className="mt-4 flex items-center justify-between">
                        <span className="text-sm text-gray-500">Aug 15 — Sep 30</span>
                        <a href="#" className="text-sm text-gray-900 hover:underline">Learn more</a>
                      </div>
                    </div>
                  </article>
                </FadeUp>
              ...
              <FadeUp>
                <div>
                  ...
                  <p className="mt-4 text-gray-700 max-w-xl">
                    Arte Gallery is a contemporary art space dedicated to presenting ambitious exhibitions and supporting artists. Our program includes curated shows, site-specific commissions, and public programs.
                  </p>
                </div>
              </FadeUp>
              <FadeUp delay={0.12}>
                <div className="grid grid-cols-2 gap-4">
                  <img src="https://images.unsplash.com/photo-1517497713463-f4a339ccd25a?q=80&w=766&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="about 1" className="w-full h-44 object-cover rounded" />
                  <img src="https://images.unsplash.com/photo-1600585154340-be6161a56a0c" alt="about 2" className="w-full h-44 object-cover rounded" />
                  <img src="https://images.unsplash.com/photo-1523731407965-2430cd12f5e4" alt="about 3" className="w-full h-44 object-cover rounded col-span-2" />
                </div>
              </FadeUp>
            </div>
          </div>
        ...
        <section id="featured" className="py-20">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <FadeUp><h2 className="text-2xl font-semibold">Featured Artworks</h2></FadeUp>
              ...
              {[
                ...
                <FadeUp key={i} delay={0.06 * i}>
                  <figure className="bg-white rounded-lg overflow-hidden shadow-sm">
                    <img src={url} alt={`Artwork ${i + 1}`} className="w-full h-56 object-cover" />
        ...
        <section id="events" className="py-20 bg-gray-100">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <FadeUp><h2 className="text-2xl font-semibold">Upcoming Events</h2></FadeUp>
            <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                <FadeUp key={i} delay={0.06 * i}>
                  <article className="bg-white p-4 rounded-lg shadow">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h3 className="text-sm font-medium">Event Title {i + 1}</h3>
                        <p className="mt-1 text-xs text-gray-500">Sep — Oct</p>
                        <p className="mt-2 text-sm text-gray-600">Short event description for visitors.</p>
                      </div>
                    </div>
                  </article>
                </FadeUp>
        ...
        <section id="blog" className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <FadeUp><h2 className="text-2xl font-semibold">From Our Blog</h2></FadeUp>
            <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                <FadeUp key={i} delay={0.06 * i}>
                  <article className="bg-white rounded-lg overflow-hidden shadow-sm">
                    <img src={url} alt={`Blog ${i + 1}`} className="w-full h-44 object-cover" />
                    <div className="p-4">
                      <h3 className="text-lg font-medium">Blog Post Title {i + 1}</h3>
                      <p className="mt-2 text-sm text-gray-600">A short excerpt from the blog post that highlights the main idea.</p>
                    </div>
                  </article>
                </FadeUp>
              ))}
        ...
        <footer className="bg-gray-900 text-gray-200 py-12">
          <div className="max-w-7xl mx-auto px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <p className="mt-3 text-sm text-gray-300">info@artegallery.example</p>
            </div>
          </div>
          <div className="mt-10 border-t border-gray-800 pt-6 text-center text-sm text-gray-400">
            © {new Date().getFullYear()} Arte Gallery. All rights reserved.
          </div>
        </footer>
      </main>
    </div>
